...
<head>
    ...
    <title>testScript.sh (editing)</title>
...
data-base-url="/"
data-file-path="testScript.sh"

  
    data-jupyter-api-token="ee3dd5db2c60e10c00da5ec1b2ca10db61c6f0b56410a085"
...
<div id="header">
  ...
  <div id="ipython_notebook" class="nav navbar-brand"><a href="/tree?token=ee3dd5db2c60e10c00da5ec1b2ca10db61c6f0b56410a085" title='dashboard'>
